...
add_action('wp_enqueue_scripts', function () {
    if ( is_front_page() || is_product() ) {
        wp_enqueue_style('swiper-style', '//unpkg.com/swiper@8/swiper-bundle.min.css', false, null);
        wp_enqueue_script('swiper-js', '//unpkg.com/swiper@8/swiper-bundle.min.js', array(), null, true);
    }
    bundle('app')->enqueue();
}, 100);
