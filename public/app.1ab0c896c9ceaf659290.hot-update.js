...
const main = async err => {
  ...
  jQuery('.products-catalog .products-pagination .products-per-page-btns .products-nav btn').click(function () {
    let num = jQuery(this).text();
    jQuery('.products-per-page').val(num).change();
  });
};
/**
 * Initialize
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "da4d80edc8316e56a746"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=app.1ab0c896c9ceaf659290.hot-update.js.map