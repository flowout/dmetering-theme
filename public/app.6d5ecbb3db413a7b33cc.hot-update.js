...
const main = async err => {
  ...
  jQuery('.products-view .products-nav .btn').click(function () {
    if (!jQuery(this).hasClass('current')) {
      console.log(jQuery('.products-catalog .products-pagination .products-per-page-btns .products-nav .btn.current'));
      jQuery('.products-catalog .products-pagination .products-per-page-btns .products-nav .btn.current').removeClass('current');
      jQuery(this).addClass('current');
      ...
      for (let i = 0; i < classList.length; i++) {
        if (classList[i] !== 'products-grid') {
          ...
          if (curr === 'columns-3') {
            jQuery('.products-catalog .products-grid').addClass('.listed');
            setCookie('woo_products_grid', 'listed', 365);
          } else {
            jQuery('.products-catalog .products-grid').addClass('.columns-3');
            setCookie('woo_products_grid', 'columns-3', 365);
          }
        }
      }
    }
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "c351723bd52cff122b30"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=app.6d5ecbb3db413a7b33cc.hot-update.js.map